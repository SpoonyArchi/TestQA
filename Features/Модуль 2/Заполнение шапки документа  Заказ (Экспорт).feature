...
@ПримерИспользования: И заполнение шапки и создание документа "Заказ"
...
@ПримерИспользования: И перезаполнение шапки документа "Заказ"
...
@ПримерИспользования: И запись документа Заказ
